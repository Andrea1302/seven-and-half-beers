...
var _leaderboard = require("./services/api/leaderboard/leaderboard");
...
var Leaderboard = function Leaderboard(_ref) {
  ...
  (0, _react.useEffect)(function () {
    getUser(); //Funzione API per prendere top giocatori\
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return (0, _leaderboard.getUsers)();

            case 2:
              res = _context2.sent;
              arrayAppoggio = res.data;
              console.log(res.data);
              arrayAppoggio.sort(function (a, b) {
                if (a.score > b.score) {
                  return -1;
                }
  ...
  var renderTopPlayers = function renderTopPlayers(player, key) {
    var top;
    ...
    }, key + 1, ") ", player.username, " - ", player.score));
  };
  ...
  }, "LEADERBOARD"), state === null || state === void 0 ? void 0 : (_state$topPlayerList = state.topPlayerList) === null || _state$topPlayerList === void 0 ? void 0 : _state$topPlayerList.map(renderTopPlayers), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      marginVertical: 30
    }
  }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
  ...
  }, "Your score : ", (_user = user) === null || _user === void 0 ? void 0 : _user.score)));
};
