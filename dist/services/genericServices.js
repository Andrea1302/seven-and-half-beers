    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            header = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
            return _context.abrupt("return", axiosInstance.post(resource, obj, {
              headers: header !== null ? {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            header = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : null;
            return _context2.abrupt("return", axiosInstance.get(resource, {
              headers: header !== null ? {
                Authorization: "Bearer ".concat(header)
              } : ""
            }).then(responseApi()).catch(responseApiError()));
