...
var Lobby = function Lobby(_ref) {
  var userMobileId = _ref.userMobileId,
      host = _ref.host,
      startGameCallback = _ref.startGameCallback,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              (0, _genericSocket.connectWithWs)(userPlayer);
  ...
  var send = function send() {
    (0, _genericSocket.sendMessageToWs)("Speriamo si zi");
  };
  ...
  }, "LOBBY PLAYERS : ", state.dataFromServer.user.length), state.dataFromServer.user.map(renderPlayer), state.dataFromServer.user.length > 1 && state.user == state.dataFromServer.user[0].id && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      alignItems: 'center',
      marginTop: 10
    }
